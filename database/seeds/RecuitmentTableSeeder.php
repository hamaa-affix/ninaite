...
class RecuitmentTableSeeder extends Seeder
{
    ...
    public function run()
    {
         DB::table('recruitments')->insert([
            ...
            'img_name' => 'https://aws-ninaite-infra.s3.us-east-2.amazonaws.com/f532cb9d19349808c8cdd87cff4b59b8_w.jpg'
        ]);
        DB::table('recruitments')->insert([
            'farm_id' => 2,
            'status' => 1,
            ...
            'summary' => 'みかんの収穫、出荷作業',
            'content' => 'XXX県でxxxの生産加工を営んでいます。時給XXX 作業内容：XXXX,期間：XXX',
            'img_name' => '/storage/images/1455141_s.jpg'
        ]);
        DB::table('recruitments')->insert([
            'farm_id' => 3,
            'status' => 1,
            ...
            'content' => 'XXX県でxxxの生産加工を営んでいます。時給XXX 作業内容：XXXX,期間：XXX',
            'img_name' => '/storage/images/3092774_s.jpg'
        ]);
        DB::table('recruitments')->insert([
            'farm_id' => 4,
            'status' => 1,
            ...
            'content' => 'XXX県でxxxの生産加工を営んでいます。時給XXX 作業内容：XXXX,期間：XXX',
            'img_name' => '/storage/images/6f60542e48f1c6c60343df42f4453b5a_w.jpg'
        ]);
        DB::table('recruitments')->insert([
            'farm_id' => 5,
            'status' => 1,
            ...
            'content' => 'XXX県でxxxの生産加工を営んでいます。時給XXX 作業内容：XXXX,期間：XXX',
            'img_name' => '/storage/images/2546105_s.jpg'
        ]);
        DB::table('recruitments')->insert([
            'farm_id' => 6,
            'status' => 1,
            ...
            'content' => 'XXX県でxxxの生産加工を営んでいます。時給XXX 作業内容：XXXX,期間：XXX',
            'img_name' => '/storage/images/1675339_s.jpg'
        ]);
        DB::table('recruitments')->insert([
            'farm_id' => 7,
            'status' => 1,
            ...
            'content' => 'XXX県でxxxの生産加工を営んでいます。時給XXX 作業内容：XXXX,期間：XXX',
            'img_name' => '/storage/images/683864_s.jpg'
        ]);
        DB::table('recruitments')->insert([
            'farm_id' => 8,
            'status' => 1,
            ...
            'content' => 'XXX県でxxxの生産加工を営んでいます。時給XXX 作業内容：XXXX,期間：XXX',
            'img_name' => '/storage/images/403591_s.jpg'
        ]);
        DB::table('recruitments')->insert([
            'farm_id' => 9,
            'status' => 1,
            ...
            'content' => 'XXX県でxxxの生産加工を営んでいます。時給XXX 作業内容：XXXX,期間：XXX',
            'img_name' => '/storage/images/500_F_277370856_RP8elHc8TckjN8qzfPYFblMmP30HSC1k.jpg'
        ]);
        DB::table('recruitments')->insert([
            'farm_id' => 10,
            'status' => 1,
            ...
            'content' => 'XXX県でxxxの生産加工を営んでいます。時給XXX 作業内容：XXXX,期間：XXX',
            'img_name' => '/storage/images/mick-haupt-oOQsLhnMHKY-unsplash.jpg'
        ]);
